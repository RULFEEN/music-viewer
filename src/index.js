...
playlists.addEventListener('click', (e)=>{
    ...
    console.log(e.target.parentNode.lastElementChild.id)
    fetch(`https://spotify81.p.rapidapi.com/playlist_tracks?id=${e.target.parentNode.lastElementChild.id}&offset=0&limit=100`, options)
	.then(res => res.json())
